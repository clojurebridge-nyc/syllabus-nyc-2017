...
- `drop` returns a lazy sequence of all _but_ the first n items in a collection: `(drop 5 (range)) => (5 6 7 8 9 ..)`
...
- `merge-with` combines two associative collections by applying a function to all matching key-value pairs:
  - `(merge-with max {:year 2016, :month "june"} {:year 2017, :day 3})` 
  - `=> {:year 2017, :month "june", :day 3}`
